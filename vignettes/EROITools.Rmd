...
Vignettes providing examples of how to use the package will be released shortly.
...
The rest of the vignettes will take will demonstrate the `EROITools` package based on the `tidy_AB_erois_dta` and `tidy_AB_erois_gma` data frames.
